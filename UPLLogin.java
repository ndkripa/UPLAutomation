...
public class UPLLogin {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='identifier']")).sendKeys("adminupl");
		driver.findElement(By.xpath("//input[@name='password']")).sendKeys("admin123@upl");
